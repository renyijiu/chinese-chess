...
import { ASSET_ROLE_BY_GAME_ROLE, pieceAssetUrl } from "../../../components/xiangqi/pieces/piece-catalog";

type PieceManifest = Readonly<{
  roles: Readonly<Record<string, Readonly<{
    variants: Readonly<Record<"red" | "black", Readonly<{
...
const manifest = JSON.parse(readFileSync(
  new URL("../../../public/models/pieces/v1/manifest.json", import.meta.url),
  "utf8",
)) as PieceManifest;
